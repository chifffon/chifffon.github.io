...
class App extends React.Component {
  columnRightStyles = "column-right";

  state = {
    advice: "",
    columnContent: <Books></Books>,
    columnLayout: false
  };
  ...
  selectBooks = () => {
    this.setState({ columnContent: <Books></Books> });
  };
...
In thousands of agonies -- I exist. I'm tormented on the rack -- but I exist! Though I sit alone in a pillar -- I exist! I see the sun, and if I don't see the sun, I know it's there. And there's a whole life in that, in knowing that the sun is there."`;
    ...
    this.columnRightStyles = this.state.columnLayout
      ? "column-right"
      : "column-right-max";
        ...
        <>
          <div className="row">
            <div className={columnLeftStyles}>
              <h1>{paragraph}</h1>
              <div>
                <a onClick={this.selectBooks}>books</a> //{" "}
              ...
              <p>
                Edit: Leaving this for me, to see how I used to act and express myself before,
                I'd like to delete it though. If I ever get embarassed enough, I will.
                <br></br>
                <br></br>
            ...
            <div className={this.columnRightStyles}>
